var myapp=angular.module("mod1",[]).controller("con1",function($scope){
    ...
    var det=[{mnu:"Culture",page:"../culture.html"},
			 {mnu:"Food",submnu:[{name:"Street Food",page:"food.html"},
                                  {name:"Resturant"}]},
			 {mnu:"Gallery",submnu:[{name:"Photos",page:"../new_angular/gal.html"}]},
			 {mnu:"South Zone",page:"../PROJECT/new.html"},
			 {mnu:"North Zone",page:""}];
    $scope.mnubar=det;
	...
	$scope.sirpic="../photo/Sir.jpg";
	$scope.sirinfo="";
	
	$scope.indrapic="../photo/Indra.jpg";
	$scope.indrainfo="";
